 ...
 */
package com.training.parveen.core.constants;

/**
 * Global class for all ParveenCore constants. You can add global constants for your extension into this class.
 */
public final class ParveenCoreConstants extends GeneratedParveenCoreConstants
{
	public static final String EXTENSIONNAME = "parveencore";


	private ParveenCoreConstants()
	{
		//empty
	}
