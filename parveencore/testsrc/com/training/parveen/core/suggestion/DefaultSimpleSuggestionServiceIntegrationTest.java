 ...
 */
package com.training.parveen.core.suggestion;
...
import com.training.parveen.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/parveencore/test/testSimpleSuggestionService.csv", "utf-8");
	}
