 ...
 */
package com.training.parveen.storefront.controllers.pages;
...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException 
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("parveenstorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("parveenstorefront.quick.order.rows.max", 25)));
