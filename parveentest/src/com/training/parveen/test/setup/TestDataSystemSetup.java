 ...
 */
package com.training.parveen.test.setup;
...
import com.training.parveen.test.constants.ParveenTestConstants;
import com.training.parveen.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ParveenTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/parveentest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/parveentest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/parveentest/import/cstickets.impex");
			...
			importImpexFile(context, "/parveentest/import/csquotes.impex");
		}
	}
}
