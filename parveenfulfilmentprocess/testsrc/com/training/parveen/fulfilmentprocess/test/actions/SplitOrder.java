 ...
 */
package com.training.parveen.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ParveenFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ParveenFulfilmentProcessConstants.PARENT_PROCESS);
